// Program calculates Poincaré Plot for D3D-Drift with Time dependent perturbations
...
if(PAR.create_flag==2) cout << "Target (0=CP, 1=inner, 2=outer, 3=shelf): " << PAR.which_target_plate << endl;
cout << endl << "Start Tracer for " << PAR.N << " points ... " << endl;
ofs2 << "Create (0=grid, 1=random, 2=target): " << PAR.create_flag << endl; 
if(PAR.create_flag==2) ofs2 << "Target (0=CP, 1=inner, 2=outer, 3=shelf): " << PAR.which_target_plate << endl;
