// Program searches for periodic fixed points in MAST Poincare-Plot
...
// Use Boundary Box and extend Boundary close to efit boundary 0.06, 2, -2, 2
bndy[0] = 0.06;  bndy[1] = 2;  bndy[2] = -2;  bndy[3] = 2;
simpleBndy = 1;
