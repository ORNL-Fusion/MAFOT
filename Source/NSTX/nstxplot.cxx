// Program calculates Poincaré Plot for NSTX with Time dependent perturbations
...
if(PAR.create_flag==2) cout << "Target (1=inner up, 2=outer up, 3=inner down, 4=outer down): " << PAR.which_target_plate << endl;
cout << endl << "Start Tracer for " << PAR.N << " points ... " << endl;
ofs2 << "Create (0=grid, 1=random, 2=target): " << PAR.create_flag << endl; 
if(PAR.create_flag==2) ofs2 << "Target (1=inner up, 2=outer up, 3=inner down, 4=outer down): " << PAR.which_target_plate << endl;
