...
case 0:	// 19.3967cm (same length as 45° target) vertical wall above 45° target, t = 0 -> -1, t=0 <=> P1 at 45° target
	R1=1.0161;	Z1=-1.22884;
	R2=1.0161;	Z2=-1.034873;
	break;
case 1:	// 45° target plate
	R1=1.0161;	Z1=-1.22884;
	R2=1.15285;	Z2=-1.3664;
	break;
case 2:	// horizontal target plate
	R1=1.15285;	Z1=-1.3664;
	R2=1.372;	Z2=-1.3664;	// normally R2=1.419845-R0, but that is inside the pump
	break;
